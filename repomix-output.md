...
Generated by Repomix on: 2025-02-09T14:26:36.439Z
...
steps:
  ...
  # service.yamlを生成（シークレットと環境変数を含む）
      ...
      - |
         ...
         spec:
           template:
             metadata:
               annotations:
                 run.googleapis.com/secrets: openai-secret:projects/$PROJECT_NUMBER/secrets/openai_api_key,langchain-tracing:projects/$PROJECT_NUMBER/secrets/langchain_tracing_v2,langchain-endpoint:projects/$PROJECT_NUMBER/secrets/langchain_endpoint,langchain-api-key:projects/$PROJECT_NUMBER/secrets/langchain_api_key,langchain-project:projects/$PROJECT_NUMBER/secrets/langchain_project,cors-origins:projects/$PROJECT_NUMBER/secrets/cors_origins
             spec:
               containers:
                 - name: frontend
